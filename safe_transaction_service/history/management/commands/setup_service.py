...
class Command(BaseCommand):
    ...
    def setup_my_network(self):
        SafeMasterCopy.objects.get_or_create(address='0xb4A7C7da1631CF60A2Cf23ABc86986f99a1A7f70',
                                             defaults={
                                                 'initial_block_number': 1461828,
                                                 'tx_block_number': 1461828,
                                             })
        ProxyFactory.objects.get_or_create(address='0xE89ce3bcD35bA068A9F9d906896D3d03Ad5C30EC',
                                           defaults={
                                               'initial_block_number': 1461801,
                                               'tx_block_number': 1461801,
                                       })
